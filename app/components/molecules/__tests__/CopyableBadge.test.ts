...
describe("CopyableBadge molecule", () => {
  ...
  it("renders icon and text", () => {
    ...
    expect(badge.classList.contains("workout-copyable-badge")).toBe(
      true,
    );
  ...
  it("uses custom className when provided", () => {
    ...
    expect(badge.classList.contains("workout-muscle-tag-badge")).toBe(
      true,
    );
    expect(badge.classList.contains("workout-copyable-badge")).toBe(
      false,
  ...
  it("adds clickable class for cursor indication", () => {
    ...
    expect(
      badge.classList.contains("workout-copyable-badge-clickable"),
    ).toBe(true);
  });
