...
import { Muscle, type MuscleGroupData } from "@app/features/dashboard/body/Muscle";
import type { MuscleConfig } from "@app/features/dashboard/body/config/MuscleConfigurations";
