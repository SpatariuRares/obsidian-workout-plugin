...
export class HeatMapColors {
  ...
  private static getLowIntensityColor(intensity: number): string {
    ...
    const r = this.interpolate(
      BASE_COLORS.LOW_START.r,
      BASE_COLORS.LOW_END.r,
      t,
    );
    const g = this.interpolate(
      BASE_COLORS.LOW_START.g,
      BASE_COLORS.LOW_END.g,
      t,
    );
    const b = this.interpolate(
      BASE_COLORS.LOW_START.b,
      BASE_COLORS.LOW_END.b,
      t,
    );
  ...
  private static getMediumIntensityColor(intensity: number): string {
    ...
    const r = this.interpolate(
      BASE_COLORS.MEDIUM_START.r,
      BASE_COLORS.MEDIUM_END.r,
      t,
    );
    const g = this.interpolate(
      BASE_COLORS.MEDIUM_START.g,
      BASE_COLORS.MEDIUM_END.g,
      t,
    );
    const b = this.interpolate(
      BASE_COLORS.MEDIUM_START.b,
      BASE_COLORS.MEDIUM_END.b,
      t,
    );
    return this.rgb(r, g, b);
  }
  ...
  private static getHighIntensityColor(intensity: number): string {
    ...
    const r = this.interpolate(
      BASE_COLORS.HIGH_START.r,
      BASE_COLORS.HIGH_END.r,
      t,
    );
    const g = this.interpolate(
      BASE_COLORS.HIGH_START.g,
      BASE_COLORS.HIGH_END.g,
      t,
    );
    const b = this.interpolate(
      BASE_COLORS.HIGH_START.b,
      BASE_COLORS.HIGH_END.b,
      t,
    );
    return this.rgb(r, g, b);
  }
