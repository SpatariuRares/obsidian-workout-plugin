...
describe("ExercisePathResolver", () => {
  describe("getExerciseFolderPaths", () => {
    it("should generate all possible paths for base path", () => {
      const paths =
        ExercisePathResolver.getExerciseFolderPaths("Esercizi");
    ...
    it("should handle path with spaces", () => {
      const paths =
        ExercisePathResolver.getExerciseFolderPaths("My Exercises");
  ...
  describe("normalizeFilePath", () => {
    it("should convert backslashes to forward slashes", () => {
      expect(
        ExercisePathResolver.normalizeFilePath("C:\\Users\\file.md"),
      ).toBe("C:/Users/file.md");
    });

    it("should handle mixed slashes", () => {
      expect(
        ExercisePathResolver.normalizeFilePath("path\\to/file.md"),
      ).toBe("path/to/file.md");
    });

    it("should handle paths with only forward slashes", () => {
      expect(
        ExercisePathResolver.normalizeFilePath("path/to/file.md"),
      ).toBe("path/to/file.md");
    });
  ...
  describe("isInExerciseFolder", () => {
    const mockFile1 = new MockTFile(
      "theGYM/Esercizi/Data/Squat.md",
    ) as TFile;
    const mockFile2 = new MockTFile(
      "Esercizi/Data/Bench Press.md",
    ) as TFile;
    const mockFile3 = new MockTFile("Other/Notes/Random.md") as TFile;
    const mockFile4 = new MockTFile(
      "theGYM/Esercizi/Deadlift.md",
    ) as TFile;

    it("should return true for file in theGYM/Esercizi/Data", () => {
      expect(
        ExercisePathResolver.isInExerciseFolder(
          mockFile1,
          "Esercizi",
        ),
      ).toBe(true);
